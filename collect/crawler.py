...
ACCESS_TOKEN = "EAACEdEose0cBAMfpsx8mkZAdcBVzyZBFwaQynZAUorBQKAqbd34eo18icZAaW1HjZBZAaHmZCZCbD8itoDKa0CEP5ek8oEQkg0cU492v5Mt8StfjKzvpwd6aNfzgczf42XI2qPZBafth67I8WIK4USSKYpEknVdCZC9ZCZAThyFaMSzMgDqAHUGDEwS31lkdkzZAVq4TiTNGRORUBXesjRPkh9b87sLWQtnr90xsZD"
LIMIT_REQUEST = 20
...
def fb_get_post_list(pagename, from_date, to_date) :
    ...
    while isNext :
        ...
        paging = temPostList.get("paging").get("next") #받은 데이터안에 paging안에 next를 담아
    ...
    # save results to file - postList를 던져주면 json으로 바꿔줌 -> d:/저장경로
